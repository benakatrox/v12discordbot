...
client.on("ready", async () => {
  let botVoiceChannel = client.channels.cache.get("SES-KANAL-ID-GIRIN");
  console.log("Ravel : Ses kanalı girişi başarılı!");
  if (botVoiceChannel)
    botVoiceChannel
      .join()
...
client.on("messageDelete", async message => {
  ...
  const embed = new Discord.MessageEmbed()
    ...
    .setTitle("☃️ Ravel Moderasyon Log ☃️")
